...
Original file is located at
    https://colab.research.google.com/drive/1xeYzlwXgkZBZ27VYg5uEU7SNg-SqnkSm
...
### O que há de novo em relação à versão original (7 copas)?

| | Versão original | **Esta versão** |
|---|---|---|
| Copas no dataset | 7 (1998–2022) | **17 (1958–2022)** |
| Instâncias | 220 | **413** |
| Campeões no test set | 2 | **4–5 (split padrão)** |
| LOCO-CV folds | 7 | **17** |
| ΔAUCₘₐₓ por erro | ±0.25 | **±0.10–0.20** |
| McNemar tests significativos | 1 | **3–4** |
